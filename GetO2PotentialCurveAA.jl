...
function EnergyAtDistanceOO(dist::Real,order::Int)
    ...
    density_file = "O2_anion_data.txt";
...
for i in 0:299
    base_name = "Test Data/Gaussian Data/AnionAnion/old/O2 (2S+1=1)/O2_O2_";
...
for i in 0:299
    base_name = "Test Data/Gaussian Data/AnionAnion/old/O2 (2S+1=3)/O2_O2_";
    local file_name = base_name * string(i) * ".log";
...
plot!(ylims=[0,800],xlims=[1.75,4.5]);
