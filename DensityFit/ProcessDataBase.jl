...
for i in 3:3
    ...
    cub_x = ReadCubeFile("data_base/"*AtomicNumberElement(i)*"_X.cub");
    cub_y = ReadCubeFile("data_base/"*AtomicNumberElement(i)*"_Y.cub");
    cub_z = ReadCubeFile("data_base/"*AtomicNumberElement(i)*"_Z.cub");
    global cub_data = (cub_x + cub_y + cub_z)./3.0;

    charges = GetAtomCharge("data_base/"*AtomicNumberElement(i)*"_X.cub");
    ...
    init_val[1] = 0.0995837849;
    init_val[2] = 1.0335545866;
    init_val[3] = 1.0167791686;

    init_val[4] = 1.0742154658;
    init_val[5] = 1.6710452453;
    init_val[6] = -1.7452607228;
